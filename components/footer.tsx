      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="animate-slide-up-fade" style={{ animationDelay: '0.1s' }}>
            <h4 className="font-bold mb-4 text-white hover:text-primary transition-colors duration-300">{language === 'en' ? 'Quick Links' : 'روابط سريعة'}</h4>
          ...
          <div className="animate-slide-up-fade" style={{ animationDelay: '0.2s' }}>
            <h4 className="font-bold mb-4 text-white hover:text-primary transition-colors duration-300">{t.services}</h4>
            <ul className="space-y-2">
              <li className="group">
                <a href="#services" className="text-gray-300 hover:text-primary transition-all duration-300 group-hover:translate-x-1 inline-block">
          ...
          <div className="animate-slide-up-fade" style={{ animationDelay: '0.3s' }}>
            <h4 className="font-bold mb-4 text-white hover:text-primary transition-colors duration-300">{t.footerContact}</h4>
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-gray-400 animate-fade-in">
          <p className="hover:text-white transition-colors duration-300">
            ...
            {language === 'en' ? ' - Web Development & Design' : ' - تطوير المواقع والتطبيقات'}
          </p>
