    ...
    <section className="relative bg-gradient-to-b from-white via-secondary/30 to-white dark:from-[#0B0F17] dark:via-slate-900/30 dark:to-[#0B0F17] pt-20 pb-20 px-4 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1
            className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground dark:text-slate-100 leading-tight mb-6 animate-slide-up-fade"
        ...
        {/* Subheadline */}
        <p
          className="text-center text-lg text-muted-foreground dark:text-slate-400 max-w-3xl mx-auto mb-12 animate-fade-in"
        ...
        {/* CTA Buttons */}
        <div
          className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-slide-up-fade"
        ...
        {/* Trust Badges */}
        <div
          className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-muted dark:bg-slate-900/50 border dark:border-slate-800 rounded-2xl p-6 md:p-8 animate-scale-in"
        ...
        >
          ...
          >
            ...
            <div>
              <p className="font-bold text-foreground dark:text-slate-100">
                {language === "en" ? "Lightning Fast" : "سرعة فائقة"}
              </p>
              <p className="text-sm text-muted-foreground dark:text-slate-400">
                {language === "en" ? "Under 2 seconds" : "أقل من ثانيتين"}
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div>
              <p className="font-bold text-foreground dark:text-slate-100">
                {language === "en" ? "Fully Responsive" : "متجاوب تماماً"}
              </p>
              <p className="text-sm text-muted-foreground dark:text-slate-400">
                {language === "en"
          ...
          >
            ...
            <div>
              <p className="font-bold text-foreground dark:text-slate-100">
                {language === "en" ? "Direct Contact" : "التواصل المباشر"}
              </p>
              <p className="text-sm text-muted-foreground dark:text-slate-400">
                {language === "en" ? "WhatsApp integrated" : "ربط واتساب مباشر"}
              </p>
            </div>
          </div>
        </div>
